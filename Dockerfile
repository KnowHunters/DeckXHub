...
RUN mkdir -p \
    ...
    chmod +x ./clawdeckx ./hermesdeckx /app/docker-entrypoint.sh && \
...
HEALTHCHECK --interval=30s --timeout=5s --start-period=60s --retries=3 \
    CMD curl -sf http://localhost:${OCD_PORT:-18788}/api/v1/health || \
